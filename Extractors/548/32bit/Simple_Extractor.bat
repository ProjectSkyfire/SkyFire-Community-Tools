...
ECHO.
ECHO.
ECHO   Project SkyFireEmu 2020(c) Open-sourced Game Emulation
ECHO             http://www.projectskyfire.org/
ECHO.
ECHO.
ECHO       Simple Map/dbc/vmap/mmaps Extraction for 5.4.8 18414
ECHO.
ECHO.
PAUSE
...
ECHO.
ECHO          Config.wtf is set at accounttype "MP"
ECHO.

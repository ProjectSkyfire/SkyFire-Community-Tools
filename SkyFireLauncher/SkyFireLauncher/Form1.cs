...
namespace SkyFirePatcher
{
    public partial class Form1 : Form
    {
        ...
        private void IsWoWOpen()
        {
            ...
            {
                MessageBox.Show("Closed - Not Confirmed Open");
            ...
            {
                MessageBox.Show("Open - Set to Confirmed");
            ...
            {
                MessageBox.Show("Open - Is Confirmed");
            ...
            {
                MessageBox.Show("Closed - Set to Confirmed");

...
namespace Connection_Patcher.Patterns
{
    class Mac
    {
        public static class x86
        {
            ...
            public static byte[] User  = { 0x40, 0x00, 0x00, 0x00, 0xE8, 0xD8, 0x33, 0xD5 };
            public static byte[] RaF   = { 0xFF, 0x00, 0x0C, 0x83, 0xEC, 0x04, 0x8B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xDB };
        }

        public static class x64
        {
            public static byte[] Send  = { 0x8B, 0x00, 0x00, 0x8B, 0x00, 0x00, 0x41, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x10 };
